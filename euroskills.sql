...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2023. Ápr 23. 15:28
...
ALTER TABLE `versenyzo`
  ADD PRIMARY KEY (`id`),
  ADD KEY `szakmaId` (`szakmaId`,`orszagId`),
...
--
ALTER TABLE `versenyzo`
  ADD CONSTRAINT `versenyzo_ibfk_1` FOREIGN KEY (`szakmaId`) REFERENCES `szakma` (`id`),
  ADD CONSTRAINT `versenyzo_ibfk_2` FOREIGN KEY (`orszagId`) REFERENCES `orszag` (`id`) ON DELETE CASCADE;
COMMIT;
